        ...
        <div class="col-md-12">
          <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create Additional Products</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              @endif
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input name="price" min="1" type="number" class="form-control" id="price" placeholder="Enter Price">
  ...
  if (requiredCheck == 1) {
    resize.croppie('result', {
      ...
      $.ajax({
        ...
        type: "POST",
        data: {"image":img,"name":name,"has_image":has_image,"price":price},
        success: function (res) {
          alert('Additional Products Created');
          location.reload();
          console.log(res);
        }
      });
