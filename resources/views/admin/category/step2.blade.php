    ...
    <div class="col-md-12">
      <div class="card card-primary">
          <div class="card-header">
            <div class="row">
              <div class="col-md-6">
                <h3 class="card-title">Update Category Banners</h3>
              </div>
              <div class="col-md-6">
                <a class="float-right" href="{{ URL::to('/') }}/admin/category/<?php echo $_REQUEST['id']; ?>/edit" class="btn btn-primary" >Back to Step 1</a>
              </div>
          ...
          <!-- form start -->
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="image">Image Banners : </label>
            ...
            <div class="row">
            <div class="col-md-12"><h2>Banners</h2></div>
