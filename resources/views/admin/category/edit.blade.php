          ...
          <div class="card card-primary">
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <a class="float-right" href="{{url('/admin/category/create/step2')}}?id={{$data->id}}">Upload Multiple Images</a>
                  </div>
                </div>
              </div>
              <!-- /.card-header -->
              ...
              @endif
                <div class="card-body">
                  <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <input name="name" type="text" class="form-control" id="name" placeholder="Enter Category Name" value="{{$data->name}}">
                    <span style="font-size: 17px;" id="required_name"></span>
                  </div>
                  <div class="row">
                    <div class="col-md-4">
                      <label for="image">Category Icon <span class="required">*</span></label>
