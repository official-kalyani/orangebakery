        ...
        <div class="col-md-12">
          <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create Occasion</h3>
              </div>
              <!-- /.card-header --> 
              <!-- form start -->
              ...
              @endif
                <div class="card-body">
                  <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <input name="name" type="text" class="form-control" id="name" placeholder="Enter Occasion Name">
    ...
    resize.croppie('result', {
      ...
      $.ajax({
        ...
        success: function (res) {
          ...
          if (res.succ == 2) {
            alert('Occasion Already Created Create a new One');
          }
        }
      });
    });
