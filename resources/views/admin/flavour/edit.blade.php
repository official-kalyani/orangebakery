        ...
        <div class="col-md-12">
          <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Flavour</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              @endif
                <div class="card-body">
                  <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <input name="name" type="text" class="form-control" id="name" placeholder="Enter Flavour Name" value="{{$data->name}}">
                    <span style="font-size: 17px;" id="required_name"></span>
                  </div>
                  <div class="row">
                    <div class="col-md-4">
                      <label for="image">Image <span class="required">*</span></label>
                      <img src="{{ URL::to('/') }}/uploads/flavour/{{ @$data->image }}" alt="" class="img-responsive" style="width: 100%;"/>
