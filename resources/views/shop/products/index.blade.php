                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php $product_prices = \App\Models\ProductPrice::where('product_id',$row->parent_product_id)->where('show_price',1)->get(); ?>
                      ...
                      <?php
                      $product_image = \App\Models\ProductImage::where('product_id',$row->parent_product_id)->where('is_featured',1)->first();
                      ?>
                      <td><img src="{{ URL::to('/') }}/uploads/product/{{ @$product_image->images }}" class="img-fluid" alt="" width="20%">
                      <td><a href="{{ url('shop/products/create') }}?id={{$row->id}}" class="btn"><i class="fas fa-edit" style="color: blue" ></i></a></td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
